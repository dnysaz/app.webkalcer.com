...
- NO rhetorical questions, at all. "Apakah X...?", "Sudah tahu belum Y?" are banned. Never ask a question just to answer it yourself (e.g. "Apakah semua keluaran aman? Tentu saja tidak."). Turn every rhetorical Q&A into a plain statement.
- NO em dashes (—) and no " " spacing games. Never use the character "—" in sentences or headings. Use commas, full stops, or colons instead. An em dash is an instant AI tell, so it is completely banned in your output.
