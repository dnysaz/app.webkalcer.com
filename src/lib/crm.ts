...
/** SEO metadata generated for an article (AI SEO Gen). */
export type SeoData = {
  title: string;
  description: string;
  hashtags: string[];
  /** Google-style preview generated by the AI. */
  preview: { url: string; title: string; description: string };
  /** Estimated SEO score (0-100). */
  score: number;
  /** AI reasoning/check notes. */
  notes: string;
};

/** SWOT analysis generated for an article. */
